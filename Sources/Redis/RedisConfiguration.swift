...
public struct RedisConfiguration: Sendable {
    public typealias ValidationError = RedisConnection.Configuration
        .ValidationError
    ...
    public init(
        ...
        guard let url = URL(string: string) else {
            throw ValidationError.invalidURLString
        }
